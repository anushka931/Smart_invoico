...
class Bill_App:
    def __init__(self, root):
        ...
        self.root.title("Smart Bill")
        bg_color = "#E6E6FA"
        title = Label(self.root, text="Quick Invoice", font=('times new roman', 30, 'bold'), pady=2, bd=12, bg="#E6E6FA", fg="Black", relief=GROOVE)
        title.pack(fill=X)
    # ================variables=======================
    ...
    # =============customer retail details======================
        F1 = LabelFrame(self.root, text="Customer Details", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="#E6E6FA")
        ...
        cphn_lbl = Label(F1, text="Customer Contact No.:", bg="#E6E6FA", font=('times new roman', 15, 'bold'))
        ...
        c_bill_lbl = Label(F1, text="Bill Number:", bg="#E6E6FA", font=('times new roman', 15, 'bold'))
    ...
    # ===================Medical====================================
        F2 = LabelFrame(self.root, text="Medical Purpose", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="#E6E6FA")
        F2.place(x=5, y=180, width=325, height=380)

        sanitizer_lbl = Label(F2, text="Sanitizer", font=('times new roman', 16, 'bold'), bg="#E6E6FA", fg="black")
        ...
        mask_lbl = Label(F2, text="Mask", font=('times new roman', 16, 'bold'), bg="#E6E6FA", fg="black")
        ...
        hand_gloves_lbl = Label(F2, text="Hand Gloves", font=('times new roman', 16, 'bold'), bg="#E6E6FA", fg="black")
        ...
        dettol_lbl = Label(F2, text="Dettol", font=('times new roman', 16, 'bold'), bg="#E6E6FA", fg="black")
        ...
        newsprin_lbl = Label(F2, text="Newsprin", font =('times new roman', 16, 'bold'), bg = "#E6E6FA", fg = "black")
        ...
        thermal_gun_lbl = Label(F2, text="Thermal Gun", font=('times new roman', 16, 'bold'), bg="#E6E6FA", fg="black")
    ...
    # ==========GroceryItems=========================
        F3 = LabelFrame(self.root, text="Grocery Items", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="#E6E6FA")
        F3.place(x=340, y=180, width=325, height=380)

        rice_lbl = Label(F3, text="Rice", font=('times new roman', 16, 'bold'), bg="#E6E6FA", fg="black")
        ...
        food_oil_lbl = Label(F3, text="Oil", font=('times new roman', 16, 'bold'), bg="#E6E6FA", fg="black")
        ...
        wheat_lbl = Label(F3, text="Wheat", font=('times new roman', 16, 'bold'), bg="#E6E6FA", fg="black")
        ...
        daal_lbl = Label(F3, text="Pulses", font=('times new roman', 16, 'bold'), bg="#E6E6FA", fg="black")
        ...
        flour_lbl = Label(F3, text="Flour", font=('times new roman', 16, 'bold'), bg="#E6E6FA", fg="black")
        ...
        maggi_lbl = Label(F3, text="Maggi", font=('times new roman', 16, 'bold'), bg="#E6E6FA", fg="black")
    ...
    # ===========ColdDrinks================================
        F4 = LabelFrame(self.root, text="Beverages", font=('times new roman', 15, 'bold'), bd=10, fg="Black", bg="#E6E6FA")
        F4.place(x=670, y=180, width=325, height=380)

        sprite_lbl = Label(F4, text="Sprite", font=('times new roman', 16, 'bold'), bg="#E6E6FA", fg="black")
        ...
        limka_lbl = Label(F4, text="Limka", font=('times new roman', 16, 'bold'), bg="#E6E6FA", fg="black")
        ...
        mazza_lbl = Label(F4, text="Mazza", font=('times new roman', 16, 'bold'), bg="#E6E6FA", fg="black")
        ...
        coke_lbl = Label(F4, text="Coke", font=('times new roman', 16, 'bold'), bg="#E6E6FA", fg="black")
        ...
        fanta_lbl = Label(F4, text="Fanta", font=('times new roman', 16, 'bold'), bg="#E6E6FA", fg="black")
        ...
        mountain_duo_lbl = Label(F4, text="Mountain Duo", font=('times new roman', 16, 'bold'), bg="#E6E6FA", fg="black")
    ...
    # =================BillArea======================
        ...
        bill_title = Label(F5, text="Billing Area", font='arial 15 bold', bd=7, relief=GROOVE)
    ...
    # =======================ButtonFrame=============
        F6 = LabelFrame(self.root, text="Billing Menu", font=('times new roman', 14, 'bold'), bd=10, fg="Black", bg="#E6E6FA")
        F6.place(x=0, y=560, relwidth=1, height=140)

        m1_lbl = Label(F6, text="Total Medical Price", font=('times new roman', 14, 'bold'), bg="#E6E6FA", fg="black")
        ...
        m2_lbl = Label(F6, text="Total Grocery Price", font=('times new roman', 14, 'bold'), bg="#E6E6FA", fg="black")
        ...
        m3_lbl = Label(F6, text="Total Beverages Price", font=('times new roman', 14, 'bold'), bg="#E6E6FA", fg="black")
        ...
        m4_lbl = Label(F6, text="Medical Tax", font=('times new roman', 14, 'bold'), bg="#E6E6FA", fg="black")
        ...
        m5_lbl = Label(F6, text="Grocery Tax", font=('times new roman', 14, 'bold'), bg="#E6E6FA", fg="black")
        ...
        m6_lbl = Label(F6, text="Beverages Tax", font=('times new roman', 14, 'bold'), bg="#E6E6FA", fg="black")
